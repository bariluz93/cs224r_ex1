...
def build_mlp(
    ...
    # 2. Create a list and append layers in order

    layers = []

    # Add the first hidden layer (input to first hidden)
    ...
    # Add the output layer (last hidden to output)
    ...
    # 3. Create the MLP model using nn.Sequential and the * operator
